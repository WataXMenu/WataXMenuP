...
local saveFile = "WataX_Key_paket.txt"
...
local function isKeyValid(k)
    local url = "https://raw.githubusercontent.com/WataXMenu/WataXMenuP/main/Loader/eldl/"..k
...
if lastKey and isKeyValid(lastKey) then
    ...
    mainFrame.Visible = false
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXMenu/WataXMenuP/main/Loader/paket779.lua"))()
end
